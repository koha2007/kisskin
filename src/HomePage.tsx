    ...
    <div className="font-display bg-background-light text-navy antialiased overflow-x-hidden">
      ...
      <section id="how" className="py-20 bg-white scroll-mt-16" aria-labelledby="how-title">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 max-w-3xl mx-auto rounded-2xl border border-amber-200 bg-gradient-to-br from-amber-50 to-orange-50 p-5 sm:p-6 flex items-start gap-4">
            <div className="shrink-0 w-10 h-10 rounded-full bg-amber-100 flex items-center justify-center">
              <span className="material-symbols-outlined text-amber-600 text-2xl">tips_and_updates</span>
            </div>
            <div className="flex flex-col gap-1">
              <h3 className="text-base font-bold text-amber-900">{t('home.how.tipTitle')}</h3>
              <p className="text-sm text-amber-800 leading-relaxed">{t('home.how.tipDesc')}</p>
            </div>
          </div>
        </div>
      </section>

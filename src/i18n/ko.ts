export default {
  ...
  'nav.results': '결과',
  'nav.my': '마이',
  'home.hero.subtitleBold': ' 5가지 K-뷰티 메이크업',
  ...
  'home.hero.previewResultLabel': '5가지 룩',
  ...
  'home.value.desc1': 'AI가 얼굴을 분석하고 60초 안에 5가지 K-뷰티 룩 + 맞춤 제품 추천을 제공합니다.',
  ...
  'home.styles.titleHighlight': '5가지 메이크업 스타일',
  ...
  'home.how.step3': '5가지 룩 확인',
  'home.how.step3Desc': '5가지 K-뷰티 메이크업 + 맞춤 제품 추천을 받으세요',
  ...
  'result.advice': '💡 맞춤 조언',
  'result.makeupStyles': '메이크업 스타일 5종',
  'result.save': '저장하기',
  'result.share': '공유하기',
  ...
  'pricing.perAnalysisF1': '5가지 메이크업 스타일',

                  ...
                  <div className="share-icons-row">
                    ...
                    {'share' in navigator && (
                      <button className="share-option" onClick={() => handleShare('native')}>
                        <div className="share-icon-circle" style={{ background: '#334155' }}>
                    ...
                    {/* ShareThis 소셜 버튼들 */}
                    <div className="st-custom-button share-option" data-network="kakao" data-url={shareUrl} data-title={shareTitle} data-image={shareImage}>
                    ...
                    <div className="st-custom-button share-option" data-network="line" data-url={shareUrl} data-title={shareTitle} data-image={shareImage}>
                    ...
                    <div className="st-custom-button share-option" data-network="whatsapp" data-url={shareUrl} data-title={shareTitle} data-image={shareImage}>
                    ...
                    <div className="st-custom-button share-option" data-network="facebook" data-url={shareUrl} data-title={shareTitle} data-image={shareImage}>
                    ...
                    <div className="st-custom-button share-option" data-network="twitter" data-url={shareUrl} data-title={shareTitle} data-image={shareImage}>
                    ...
                    <div className="st-custom-button share-option" data-network="pinterest" data-url={shareUrl} data-title={shareTitle} data-image={shareImage}>
                    ...
                    <div className="st-custom-button share-option" data-network="telegram" data-url={shareUrl} data-title={shareTitle} data-image={shareImage}>
                    ...
                    <div className="st-custom-button share-option" data-network="linkedin" data-url={shareUrl} data-title={shareTitle} data-image={shareImage}>
                    ...
                    <div className="st-custom-button share-option" data-network="reddit" data-url={shareUrl} data-title={shareTitle} data-image={shareImage}>
                    ...
                    <div className="st-custom-button share-option" data-network="email" data-url={shareUrl} data-title={shareTitle} data-image={shareImage}>

  ...
  return (
    <div className="legal-page">
      ...
      <div className="legal-content">
        ...
        <p>By accessing or using kisskin (<a href="https://kisskin.net" target="_blank" rel="noopener noreferrer">https://kisskin.net</a>), you agree to be bound by these Terms of Service ("Terms"). If you do not agree, do not use the Service. These Terms constitute a legally binding agreement between you and kisskin.</p>
        ...
        <p>kisskin shall not be liable for any failure or delay in performance due to circumstances beyond our reasonable control, including but not limited to natural disasters, war, terrorism, pandemics, government actions, power failures, internet disruptions, or third-party service outages (including OpenAI or Polar).</p>
        ...
        <p>These Terms, together with our <a className="legal-link" onClick={() => onNavigate('privacy')}>Privacy Policy</a> and <a className="legal-link" onClick={() => onNavigate('refund')}>Refund Policy</a>, constitute the entire agreement between you and kisskin regarding the use of the Service. Any prior agreements, communications, or understandings are superseded.</p>

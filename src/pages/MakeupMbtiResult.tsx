...
export default function MakeupMbtiResult({ code }: Props) {
  ...
  return (
    <div className="font-display bg-background-light min-h-screen">
      ...
      {/* Detail paragraphs (SEO body) */}
      <section className="py-14 md:py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl md:text-3xl font-extrabold text-navy text-center mb-3 tracking-tight">
            {type.koName} 유형은 어떤 메이크업을 할까?
          </h2>
          <p className="text-center text-slate-500 text-sm mb-10">
            MBTI 이론 · 해외 뷰티 아키타입 연구 · 국내 실증 조사를 종합해 서술한 유형 분석입니다.
          </p>

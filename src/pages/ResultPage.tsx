            ...
            <div className="share-overlay" onClick={(e) => { if (e.target === e.currentTarget) setShowShareMenu(false) }}>
              <div className="share-modal">
                ...
                <div className="share-icons-row">
                  {'share' in navigator && (<button className="share-option" onClick={() => handleSharePlatform('native')}><div className="share-icon-circle" style={{ background: '#3E4F94' }}><span className="material-symbols-outlined">phone_iphone</span></div>{t('result.defaultShare')}</button>)}

...
export const FACE_SHAPE_TYPES: Record<FaceShapeCode, FaceShapeType> = {
  oval: {
    ...
    card: {
      ...
      nicknameEn: 'Effortless Pearl',
      identityLineEn: 'The face that carries any style you hand it',
      hashtagsEn: ['#OvalFace', '#BalancedFeatures', '#WearsAnything', '#IdealProportions'],
    },
    koName: '계란형',
    enName: 'Oval',
    emoji: '🥚',
  ...
  round: {
    ...
    card: {
      ...
      nicknameEn: 'Lovely Round Gem',
      identityLineEn: 'Soft lines that read warm and kind',
      hashtagsEn: ['#RoundFace', '#LovelyLook', '#YouthfulCharm', '#WarmImpression'],
    },
    koName: '둥근형',
    enName: 'Round',
    emoji: '🌕',
  ...
  square: {
    ...
    card: {
      ...
      nicknameEn: 'Bold Square Gem',
      identityLineEn: 'Defined lines that carry real presence',
      hashtagsEn: ['#SquareFace', '#Charisma', '#DefinedJawline', '#StrongPresence'],
    },
    koName: '각진형',
    enName: 'Square',
    emoji: '🧊',
  ...
  oblong: {
    ...
    card: {
      ...
      nicknameEn: 'Elegant Long Gem',
      identityLineEn: 'A grown, chic air you never have to perform',
      hashtagsEn: ['#LongFace', '#ChicMood', '#MatureElegance', '#Refined'],
    },
    koName: '긴형',
    enName: 'Oblong / Long',
    emoji: '🫒',
  ...
  heart: {
    ...
    card: {
      ...
      nicknameEn: 'Shining Heart Gem',
      identityLineEn: 'A broad brow, a delicate chin — a lovely V-line',
      hashtagsEn: ['#HeartFace', '#VLine', '#LovelyShape', '#SlimChin'],
    },
    koName: '하트형',
    enName: 'Heart',
    emoji: '💖',

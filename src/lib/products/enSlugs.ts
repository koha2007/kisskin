...
export const EN_PRODUCT_SLUGS = [
  ...
  'wakemake-soft-blurring-eye-palette-candy-coral',
  'ysl-loveshine-lip-oil-stick',
  'mumchit-soft-blue-soap-fabric-perfume',
  'gisou-honey-infused-hair-oil',
  'drjart-cicapair-serum',
  'natasha-denona-tan-eyeshadow-palette',
  'romand-better-than-cheek-blueberry-chip',
  'tirtir-mask-fit-red-cushion',
  'nobev-slim-edge-dual-eyeliner',
  'rhode-peptide-lip-tint-jelly-bean',

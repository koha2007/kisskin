...
export const EN_PRODUCT_SLUGS = [
  'lilybyred-lovebeam-cheek-balm',
  'etude-color-fix-skinny-mascara',
  'poment-cotton-hug-perfume',
  ...
  'clio-pro-eye-palette-air-08-latte-seonim',
  'laneige-juicepop-box-lip-tint',
  'fomant-cotton-kiss',
  'moroccanoil-high-shine-gloss-mask',
  'isntree-hyaluronic-airy-sun-stick',
  'rare-beauty-soft-pinch-luminous-palette',
  'deardahlia-petal-drop-liquid-blush',
  ...
  'numbuzin-hydra-soothing-serum',
  'louis-vuitton-ombres-monogram-limited-palette',
  'peripera-sunshine-cheek',
  'haus-labs-triclone-skin-tech-foundation',
  'clio-pro-eye-palette-air',
  'revlon-super-lustrous-glass-shine-balm',
  'mumchit-stay-perfume',

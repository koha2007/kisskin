...
export const PRODUCT_ITEMS: ProductPost[] = [
  ...
  },
  {
    ...
    brand: '클리오',
    name: '프로 아이 팔레트 에어',
    title: '클리오 프로 아이 팔레트 에어 – 데일리부터 포인트까지 흔들림 없는 컬러 조합',
    summary:
      '글로우픽에서 리뷰 1,320개, 평점 4.64로 상위권에 오른 클리오의 아이섀도우 팔레트로, 자연스러운 발색과 뛰어난 활용도로 데일리 메이크업에 적합합니다.',
    highlights: ['가루·펄 날림 적은 밀착력', '쿨·웜 활용 가능한 색 구성', '휴대 좋은 컴팩트 사이즈'],
    details: [
      '가루나 펄이 날리지 않고 눈에 가볍게 밀착되어 오랜 시간 깔끔한 컬러 유지가 가능합니다.',
      '여름 쿨톤부터 가을 웜톤까지 두루 어울리는 컬러 배합으로, 톤 상관없이 다양한 메이크업 스타일링 가능.',
      '작고 가벼운 컴팩트 사이즈로 휴대가 간편하며, 베이스부터 포인트까지 하나의 팔레트로 완성 가능.',
    ],
    whoFor:
      '자연스러운 데일리 음영부터 포인트 메이크업까지 한 팔레트로 해결하고 싶은 사용자에게 적합합니다. 특히 여름 쿨톤이나 가을 웜톤 피부를 가진 분들에게 컬러 활용도가 높습니다.',
    howTo: [
      '베이스 컬러로 전체 눈두덩이에 얇게 깔아 준 다음, 중간 톤 음영 컬러로 눈두덩이 중앙과 눈꼬리에 레이어링합니다.',
      '포인트 색상은 손가락 또는 작은 브러시로 중심부에 톡톡 얹어 자연스럽게 블렌딩해 입체감을 더해줍니다.',
    ],
    pros: [
      '가루·펄 날림 적고 밀착력 뛰어나 하루 종일 컬러 유지',
      '쿨·웜 톤 모두 활용 가능한 다채로운 색 구성',
    ],
    cons: [
      '일부 컬러는 쿨하거나 탁해 호불호 있을 수 있음',
    ],
    colorFit:
    ...
    clioCategory: 'eye',
    date: '2026-08-23',
    tags: ['클리오', '아이섀도우팔레트', '데일리음영'],
    seoTitle: '클리오 프로 아이 팔레트 에어 인기 아이섀도우 팔레트',
    seoDescription:
      '글로우픽·올리브영 인기 상위권, 다양한 쿨·웜 톤 모두 활용 가능한 아이섀도우 팔레트의 실사용 리뷰 확인',
  },
  {

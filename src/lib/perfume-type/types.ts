...
export const PERFUME_TYPES: Record<PerfumeTypeCode, PerfumeType> = {
  floral: {
    ...
    card: {
      ...
      gradient: ['#232a52', '#8e6e9e'],
      nicknameEn: 'The Flower Field Romantic',
      identityLineEn: 'You carry an elegant, romantic air with you',
      hashtagsEn: ['#Floral', '#RomanticScent', '#FlowerNotes', '#SoftFeminine'],
    },
    koName: '로맨틱 플로럴',
    koFamily: 'Floral',
    enName: 'Floral',
  ...
  citrus: {
    ...
    card: {
      ...
      nicknameEn: 'The Crisp Morning Riser',
      identityLineEn: 'A bright, wide-awake first impression',
      hashtagsEn: ['#Citrus', '#ZestyScent', '#Refreshing', '#DailyPerfume'],
    },
    koName: '상큼 시트러스',
    koFamily: 'Citrus',
    enName: 'Citrus',
  ...
  woody: {
    ...
    card: {
      ...
      gradient: ['#232a52', '#8a6a45'],
      nicknameEn: 'The Deep Forest Keeper',
      identityLineEn: 'Calm and grounded — the kind people trust',
      hashtagsEn: ['#Woody', '#CalmScent', '#CozyWarmth', '#SignatureScent'],
    },
    koName: '포근 우디',
    koFamily: 'Woody',
    enName: 'Woody',
  ...
  amber: {
    ...
    card: {
      ...
      gradient: ['#232a52', '#d8503c'],
      nicknameEn: 'The Amber Enchanter',
      identityLineEn: 'A warm, deep trail that lingers after you leave',
      hashtagsEn: ['#Amber', '#SensualScent', '#DeepTrail', '#NightPerfume'],
    },
    koName: '관능 앰버',
    koFamily: 'Amber',
    enName: 'Amber',
  ...
  fresh: {
    ...
    card: {
      ...
      nicknameEn: 'The Cool Breeze Drifter',
      identityLineEn: 'A clean, cool first impression every time',
      hashtagsEn: ['#Fresh', '#CoolScent', '#CleanNotes', '#SummerPerfume'],
    },
    koName: '청량 프레시',
    koFamily: 'Fresh',
    enName: 'Fresh',
  ...
  gourmand: {
    ...
    card: {
      ...
      nicknameEn: 'The Sweet Dessert Dreamer',
      identityLineEn: 'A cozy, lovable mood wherever you go',
      hashtagsEn: ['#Gourmand', '#SweetScent', '#DessertNotes', '#CozyMood'],
    },
    koName: '달콤 구르망',
    koFamily: 'Gourmand',
    enName: 'Gourmand',

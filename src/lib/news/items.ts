...
export const NEWS_ITEMS: NewsItem[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '대표 서비스는 (1) Olay Skin Advisor — 사용자의 셀카로 7가지 피부 지표를 분석해 제품 추천. (2) Function of Beauty — 50가지 이상 변수를 입력하면 AI가 처방한 커스텀 화장품을 제조. (3) Curology — 피부과 의사 + AI가 결합한 처방형 스킨케어. (4) kissinskin AI Makeup — 셀카로 6가지 K-뷰티 룩을 시뮬레이션하고 메이크업 MBTI·퍼스널 컬러·얼굴형을 분석.',

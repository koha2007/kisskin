...
export const EN_NEWS_SLUGS = [
  ...
  'nooni-apple-seed-lip-oil-target-us-debut',
  'soft-focus-blur-makeup-trend-kbeauty',
  'loreal-cosmax-next-gen-collab',
  'loreal-cosmax-kbeauty-innovation-mou',
  'k-beauty-record-august-exports-small-brands-rise',
  'oliveyoung-sephora-singapore-k-beauty-edit-launch',
  'record-k-beauty-exports-july-2026-surpass-1-35-billion',
  'seoul-beauty-week-global-k-beauty-second-largest-industry',
  'laneige-matin-kim-global-cosmetics-fashion-collab',
  'risky-glowcation-influencer-trip-to-seoul',
  'skin1004-lab-in-nature-new-azulen-peptide-nad-creams',
  'kaja-target-beauty-studio-us-launch',
  'kbeauty-exports-indie-brands-record-h1-2026',
  'watercolor-makeup-global-trend-emerges',
  'cosrx-peptide-signal-station-olive-young-festa-la',
  'athe-vegan-relief-bb-cushion-launch',
  'kbeauty-exports-third-golden-age-diversification',
  'kaja-joins-target-beauty-studio-us-launch',
  'seoul-to-soho-k-beauty-experience-new-york-pop-up',
  'seoul-beauty-week-global-k-beauty-platform',

...
export const GUIDE_POSTS_EN: GuidePost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '> TOOL: Which 10-minute face suits you? | /en/tools/makeup-mbti/ | Free makeup MBTI · 8 questions · no signup · your type comes with its own lip, eye and base palette',
  ...
  },
  {
    ...
    body: [
      ...
      '> TOOL: Find your makeup personality type | /en/tools/makeup-mbti/ | Free makeup MBTI · 8 questions · no signup · 16 types, each with its own lip, eye and base palette',

...
export const PERSONAL_COLOR_TYPES: Record<SeasonCode, PersonalColorType> = {
  spring: {
    ...
    card: {
      ...
      gradient: ['#232a52', '#ff9e6b'],
      nicknameEn: 'Fairy of Spring Light',
      identityLineEn: 'You glow bright, and the room lifts with you',
      hashtagsEn: ['#SpringWarm', '#BrightGlow', '#FreshMakeup', '#CoralLip'],
    },
    koName: '봄 웜톤',
    enName: 'Spring Warm',
    emoji: '🌸',
    ...
    detailParagraphs: [
      '봄 웜톤은 한국인 중 약 20~25%에게 해당하는 밝고 따뜻한 톤이에요. 피부는 노란빛을 띠면서도 맑고 투명하며, 홍조는 거의 없거나 미미한 편이죠. 햇볕 아래에서는 빛나는 듯하고, 그늘에서도 여전히 화사함을 잃지 않아요. 이 계절의 시그니처 공식은 바로 \'고명도, 중~고채도의 따뜻한 컬러\'랍니다. 이런 컬러들이 얼굴에 생기를 불어넣어 줄 거예요.',
      '가장 잘 어울리는 컬러는 코랄, 피치, 써니 옐로우, 아이보리, 그리고 브라이트 터쿼이즈예요. 특히 코랄과 피치는 립과 블러셔의 시그니처 컬러군인데요, 입술과 볼에 바르면 얼굴 전체가 \'햇살을 머금은 듯\' 생기 있어 보인답니다. 반대로 버건디, 딥 네이비, 차콜 그레이 같은 쿨톤은 피부를 칙칙하고 어둡게 만들 수 있으니 의식적으로 피하는 것이 좋아요.',
      '메이크업은 \'글로우, 글로우, 글로우\'가 핵심이에요. 옐로우 베이스의 가벼운 파운데이션을 사용하고, 립은 코랄 오렌지, 피치, 살몬 핑크를 번갈아 활용해보세요. 아이 메이크업은 샴페인 골드, 라이트 브라운, 웜 피치 컬러가 눈매를 가장 아름답게 표현해 줄 거예요. 볼 중앙에 피치나 살몬 코랄 블러셔를 얹으면 봄 웜톤 특유의 싱그러움을 더할 수 있답니다.',
      '액세서리는 실버보다는 골드가 훨씬 잘 어울려요. 옐로우 골드와 로즈 골드가 따뜻한 피부 톤과 가장 조화롭게 어우러지죠. 헤어 컬러는 허니 브라운, 카라멜 같은 따뜻한 브라운 계열이 제격이에요. 애쉬 계열로 과도하게 탈색하면 피부가 오히려 노랗게 보일 수 있으니 주의하세요.',
      '봄 웜톤이 빠지기 쉬운 함정은 \'어떤 밝은 색이든 다 잘 어울릴 것\'이라고 생각하는 거예요. 쿨 핑크, 아이스 블루 같은 차가운 계열의 밝은 색은 오히려 피부를 창백하게 만들 수 있답니다. 진짜 공식은 \'밝고 따뜻한(bright AND warm)\' 컬러를 함께 사용하는 것이에요. 이 두 가지 조건을 모두 충족하는 컬러만이 진정으로 여러분의 것이랍니다.',
    ],
  ...
  summer: {
    ...
    card: {
      ...
      gradient: ['#232a52', '#7aa6ff'],
      nicknameEn: 'Muse of Summer Dawn',
      identityLineEn: 'Soft and cool — the easiest person to be around',
      hashtagsEn: ['#SummerCool', '#PastelPalette', '#AiryMakeup', '#RoseLip'],
    },
    koName: '여름 쿨톤',
    enName: 'Summer Cool',
    emoji: '💎',
    ...
    detailParagraphs: [
      'Summer Cool, 즉 여름 쿨톤은 한국에서 가장 흔하게 찾아볼 수 있는 퍼스널 컬러예요. 전체 인구의 약 35~40%가 이 타입에 속하죠. 피부는 푸른색 또는 분홍색의 언더톤으로 밝게 빛나며, 피부가 얇아 손목 안쪽의 혈관이 선명한 파란색으로 보이는 경우가 많아요. 얼굴에 홍조가 올라와도 따뜻한 느낌보다는 시원하고 맑은 느낌으로 나타난답니다.',
      '여름 쿨톤에게 가장 잘 어울리는 컬러는 라벤더, 베이비 블루, 로즈 핑크, 그리고 소프트 라일락이에요. \'저채도, 중~고명도의 시원한 파스텔 톤\'이 핵심이죠. 원색의 강렬함보다는 물 탄 듯 부드러운 컬러들이 여름 쿨톤의 매력을 더욱 돋보이게 해요. 반대로 오렌지, 머스타드, 카키 같은 웜톤 계열의 색상은 피부 톤을 칙칙하게 만들 수 있으니 피하는 것이 좋아요.',
      '메이크업은 \'톤 다운된 시원한 파스텔\'에 집중해 주세요. 핑크 베이스 파운데이션을 사용하고, 립스틱은 로즈 핑크, 쉬어 플럼, 소프트 라즈베리 계열을 추천해요. 특히 쉬어 피니시 립은 여름 쿨톤의 맑고 깨끗한 이미지를 더욱 강조해 준답니다. 아이섀도는 라벤더, 소프트 모브, 쿨 브라운 컬러로 부드럽게 깊이감을 더하고, 볼 중앙에 로즈 핑크 블러셔를 살짝 얹어 마무리하면 완벽한 룩을 연출할 수 있어요.',
      '액세서리는 실버, 화이트 골드, 플래티넘이 얼굴을 환하게 밝혀줄 거예요. 옐로우 골드는 피부를 칙칙하게 보이게 할 수 있으니 피하는 것이 좋고요. 헤어 컬러는 애쉬 계열, 특히 라벤더 애쉬나 블루 블랙이 시원한 느낌을 한층 더 살려준답니다. 오렌지 브라운이나 카라멜 컬러는 피해주세요.',
      '여름 쿨톤이 흔히 하는 고민 중 하나는 \'너무 부드러워 보여요 / 강렬한 느낌이 없어요\'일 거예요. 하지만 그 부드러움이야말로 여름 쿨톤의 강점이지, 고쳐야 할 단점이 아니랍니다. 채도 높은 컬러로 존재감을 더하려 하면 오히려 역효과가 날 수 있어요. 부드러운 파스텔 톤 안에서 우아함을 추구하는 것이 여름 쿨톤을 위한 가장 현명한 해답이에요.',
    ],
  ...
  autumn: {
    ...
    card: {
      ...
      gradient: ['#232a52', '#b5651d'],
      nicknameEn: 'Muse of Autumn Woods',
      identityLineEn: 'Deep and calm — a quiet pull people follow',
      hashtagsEn: ['#AutumnWarm', '#MutedTones', '#BrickLip', '#DeepMood'],
    },
    koName: '가을 웜톤',
    enName: 'Autumn Warm',
    emoji: '🍂',
    ...
    detailParagraphs: [
      '가을 웜톤은 국내 사계절 퍼스널 컬러 중 가장 희귀한 타입으로, 전체 인구의 약 10~15% 정도를 차지해요. 피부 톤은 중간에서 어두운 밝기에 노란 기가 돌고, 붉은 기나 홍조가 거의 없으며 햇볕에 잘 타는 편이죠. 홍조가 잘 보이지 않아 간혹 ‘피곤해 보인다’는 오해를 받기도 하지만, 사실 가을 웜톤은 깊고 풍부한 컬러를 가장 잘 소화하는 타입이랍니다.',
      '가장 잘 어울리는 컬러는 머스타드, 카키, 버건디, 올리브 그린, 테라코타, 카라멜이에요. ‘중간에서 낮은 밝기, 중간 채도의 따뜻하고 깊은 컬러’가 핵심이죠. 가을 단풍 같은 브라운, 오크 와인 같은 레드, 숲 속 이끼 같은 올리브 컬러를 떠올려보세요. 이런 색들이 가을 웜톤의 고급스러운 매력을 한껏 끌어올려 줄 거예요.',
      '메이크업은 ‘차분하고 따뜻한 딥 컬러’에 집중해 주세요. 옐로우 베이스의 미디움 파운데이션이 피부에 가장 잘 맞아요. 립은 브릭, 테라코타, 딥 레드 오렌지, 버건디 오렌지 컬러를 번갈아 사용해 보세요. 아이섀도는 브론즈, 딥 브라운, 올리브, 코퍼 계열이 눈매를 성숙하고 깊이 있게 연출해주고, 테라코타 블러셔를 애플존에 자연스럽게 블렌딩하면 완벽한 룩이 완성됩니다.',
      '액세서리는 옐로우 골드, 브론즈, 코퍼가 피부의 따뜻한 톤과 잘 어울려요. 실버나 화이트 골드는 피부를 칙칙하고 생기 없어 보이게 할 수 있으니 가급적 피하거나 최소한으로 사용해 주세요. 헤어 컬러는 다크 브라운, 코퍼 브라운, 초콜릿 브라운이 베스트! 애쉬 계열의 과도한 탈색은 피부 톤과 부딪혀 어울리지 않으니 주의하세요.',
      '가을 웜톤이 흔히 저지르는 실수는 바로 밝은 핑크 립을 선택하는 거예요. 핑크 베이스 립은 이 피부 톤과 강하게 충돌하여 얼굴을 창백하고 아파 보이게 만들 수 있어요. 오렌지, 브라운, 딥 레드 트리오 안에서만 머물러 주세요. 이 컬러들이야말로 가을 웜톤의 지적이고 고가치적인 매력을 빛나게 해줄 테니까요.',
    ],
  ...
  winter: {
    ...
    card: {
      ...
      gradient: ['#232a52', '#c026d3'],
      nicknameEn: 'Chic of Winter Night',
      identityLineEn: 'Sharp and chic — you set the tone of the room',
      hashtagsEn: ['#WinterCool', '#HighContrast', '#RedLip', '#ChicLook'],
    },
    koName: '겨울 쿨톤',
    enName: 'Winter Cool',
    emoji: '❄️',
    ...
    detailParagraphs: [
      'Winter Cool 타입은 한국에서 비교적 드문 편(약 15~20%)인데요, 푸른빛이 도는 창백한 피부와 아주 진한 머리카락의 강렬한 대비가 특징이에요. 가장 전형적인 조합은 ‘홍조 없는 도자기 피부 + 푸른빛이 도는 검은 눈동자 + 순수한 검은 머리카락’으로, 전체적으로 도시적이고 시크한 분위기를 풍긴답니다.',
      '가장 잘 어울리는 컬러는 트루 블랙, 퓨어 화이트, 핫 핑크, 로얄 블루, 에메랄드예요. 핵심 규칙은 ‘높은 채도 + 극명한 명도 대비(아주 밝거나 OR 아주 어둡거나)’인데요. 따뜻한 기운 없는 트루 레드, 푸른빛이 감도는 플럼처럼 회색빛 없이 선명한 순색들이 Winter Cool이 가진 강렬한 대비와 가장 잘 어울린답니다.',
      '메이크업은 ‘고대비의 쿨톤’을 지향해야 해요. 핑크 또는 뉴트럴 쿨톤 파운데이션을 매트하거나 세미 매트하게 마무리해주세요. 립은 블랙 체리, 트루 레드, 와인 플럼, 쿨 핫 핑크처럼 강렬한 컬러로 포인트를 주는 게 좋아요. 아이섀도는 블랙, 딥 네이비, 실버 글리터로 눈매를 또렷하게 연출하고, 쿨 로즈 블러셔를 소량만 사용해 대비감을 살려주는 것이 중요해요.',
      '실버, 플래티넘, 화이트 골드 주얼리가 피부 톤을 더욱 돋보이게 해줘요. 옐로우 골드는 잘 어울리지 않으니 피하는 것이 좋답니다. 헤어 컬러는 블루 블랙, 차콜, 애쉬 실버처럼 차가운 느낌의 다크 컬러가 깔끔한 인상을 유지시켜줘요. 오렌지나 코퍼 같은 웜톤은 타고난 대비감을 깨뜨려 어색해 보일 수 있어요.',
      'Winter Cool 타입이 흔히 하는 실수 중 하나는 ‘세련돼 보이고 싶어서 베이지나 카멜 코트를 입는 것’인데요. 웜톤 뉴트럴 컬러는 타고난 대비감을 희석시켜 옷차림을 밋밋하게 만들 수 있어요. 뉴트럴 컬러가 필요할 때는 차콜, 퓨어 화이트, 쿨 그레이처럼 차가운 계열을 선택하는 것이 좋답니다.',
    ],

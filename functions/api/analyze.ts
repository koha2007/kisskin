...
3. 각 칸 하단에 메이크업 이름을 크고 선명한 흰색 텍스트로 반드시 표시해줘. 글씨에 오류가 없도록 정확하게 작성해.
4. 그리드 라인을 명확하게 표시해줘.
5. 9칸 모두 동일한 크기로 균등하게 배치하고 위,아래,좌,우 여백도 균등하게 생성해줘.
6. 총 9가지 메이크업 스타일을 확실하고 정확하게 자연스럽게 표현해줘.

9가지 메이크업과 각 칸에 표시할 이름:
1번 칸: "내추럴 글로우" - 자연스러운 광채 내추럴 글로우 메이크업
2번 칸: "클라우드 스킨" - 뽀얀 구름같은 클라우드 스킨 메이크업
3번 칸: "블러드 립" - 진한 입술 강조 블러드 립 메이크업
4번 칸: "맥시멀리스트 아이" - 화려한 눈 강조 맥시멀리스트 아이 메이크업
5번 칸: "메탈릭 아이" - 금속 광택 메탈릭 아이 메이크업
6번 칸: "볼드 립" - 강렬한 입술 볼드 립 메이크업
7번 칸: "블러쉬 드레이핑" - 블러쉬 드레이핑&레이어링 메이크업
8번 칸: "그런지" - 어둡고 거친 그런지 메이크업
9번 칸: "K-pop 아이돌" - K-pop 아이돌 스타일 메이크업

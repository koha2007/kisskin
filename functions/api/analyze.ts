...
이 사진을 인스타그램 9분할 그리드용으로 변환해줘. 비율에 맞게 크롭할지 여백을 추가할지 자동으로 판단해서 최대한 사진이 잘리지 않게 해줘. 전체를 3x3 그리드로 균등하게 9등분해줘. 총 9가지 메이크업 스타일 확실하고 정확하게 자연스럽게 표현해줘. 사진 해상도 높여줘. 다시 한번 강조: 이미지 위에 어떤 텍스트도 절대 넣지 마. 스타일 이름, 번호, 라벨 등 일체 금지.`

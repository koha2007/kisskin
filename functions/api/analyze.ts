...
2: 스킨케어 하이브리드 베이스 - 스킨케어 제품을 바른 듯 촉촉하고 건강한 윤광 피부. 가벼운 틴티드 모이스처라이저 느낌의 자연스러운 커버. 입술도 보습감 있게, 눈썹은 자연스럽게 정리
3: 디퓨즈드 립 - 입술 안쪽부터 자연스러운 로즈/코랄 컬러가 바깥으로 부드럽게 번지는 그라데이션 립. 입술 색이 화사하게 눈에 띄어야 해. 피부는 깨끗하고 맑게
4: 그런지 / 스모키 아이 - 눈두덩이에 차콜+카키+다크브라운을 거칠게 블렌딩한 그런지 무드. 언더라인까지 스모키하게 번진 느낌. 입술은 말린 장미색 매트. 전체적으로 어둡고 반항적인 분위기지만 피부는 깨끗하게
5: 톤인톤 모노크롬 - 따뜻한 테라코타/피치 하나의 색으로 아이섀도·블러셔·립을 부드럽게 통일. 컬러가 자연스럽지만 확실히 보이게. 화사하고 조화로운 느낌
6: 유틸리티 메이크업 - 기능성 남성 전용 메이크업. 컨실러로 잡티·다크서클 완벽 커버, 눈썹을 깔끔하고 선명하게 정리, 입술에 자연스러운 틴트 발색. 메이크업했다는 티 없이 깔끔하고 단정한 인상. 비즈니스 느낌
...
핵심: 사용자의 얼굴은 절대 변경하지 마! 원본과 동일한 사람이어야 해! 메이크업만 다르게! 아이라인을 굵고 진하게 그리지 마 - 얇고 자연스럽게! 모든 메이크업은 화사하고 세련되게 표현해! 9가지가 각각 뚜렷하게 구분되어야 하지만 과하거나 두껍게 보이면 안 돼! 9칸 모두 원본과 동일한 얼굴·피부색·모자·옷·액세서리를 유지해야 해! 머리카락 색 변경은 오직 9번에서만! 이미지 위에 어떤 글자도 렌더링하지 마.`

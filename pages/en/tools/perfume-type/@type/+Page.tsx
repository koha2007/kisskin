  ...
  if (!t) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-background-light gap-4 px-4 text-center">
        <h1 className="text-2xl font-extrabold text-navy">Perfume type not found</h1>
        <a href="/en/tools/perfume-type/" className="bg-rose-500 text-white px-6 py-3 rounded-full font-bold">Back to the quiz</a>
      </div>
    )
  }

export default function Head() {
  return (
    <>
      ...
      <meta property="og:title" content="환불 정책 | kissinskin" />
      <meta property="og:description" content="kissinskin AI K-뷰티 메이크업 시뮬레이터 환불 정책." />
      <meta property="og:image" content="https://kissinskin.net/og-image.png" />
      <meta property="og:site_name" content="kissinskin" />
      <meta property="og:locale" content="ko_KR" />
      <meta property="og:locale:alternate" content="en_US" />
      <meta name="twitter:card" content="summary" />
      <meta name="twitter:title" content="환불 정책 | kissinskin" />
      <meta name="twitter:description" content="kissinskin AI K-뷰티 메이크업 시뮬레이터 환불 정책." />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 2, "name": "환불 정책", "item": "https://kissinskin.net/refund/" }
        ]
      }) }} />
    </>
  )

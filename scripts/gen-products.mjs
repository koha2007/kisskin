...
{ "brand": "...", "name": "...", "title": "...", "summary": "...", "highlights": ["..."], "details": ["..."], "tags": ["..."] }

Korean:
\`\`\`json
${JSON.stringify({ brand: item.brand, name: item.name, title: item.title, summary: item.summary, highlights: item.highlights, details: item.details || [], tags: item.tags }, null, 2)}
\`\`\``
